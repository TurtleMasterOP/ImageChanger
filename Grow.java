...
public class Grow {
    ...
    public static void grow(String filename, int scale) throws IOException{
        ...
        for (int col = 0; col < newImage.getWidth()-scale; col ++){
            for(int row = 0; row < newImage.getHeight()-scale; row++){
                ...
                Color color2 = new Color(image.getRGB(ul_col + 1, ul_row)); //b
                Color color3 = new Color(image.getRGB(ul_col + 1, ul_row + 1)); //c
                Color color4 = new Color(image.getRGB(ul_col, ul_row + 1)); //d
        ...
        //writes output image
        ImageIO.write(newImage, "jpg", new File("grow.jpg"));
